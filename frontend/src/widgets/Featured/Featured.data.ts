...
export const FEATURED_PROJECT = {
    ...
    slides: [
        {
            src:   "https://raw.githubusercontent.com/https-shini/AuthService/refs/heads/main/read-model/img/Login01.png",
        ...
        {
            src:   "https://raw.githubusercontent.com/https-shini/AuthService/refs/heads/main/read-model/img/Cadastro01.png",
            label: { pt: "Cadastro",                  en: "Registration" },
            sub:   { pt: "Medidor de força de senha", en: "Password strength meter" },
            description: {
        ...
        {
            src:   "https://raw.githubusercontent.com/https-shini/AuthService/refs/heads/main/read-model/img/Home01.png",
        ...
        {
            src:   "https://raw.githubusercontent.com/https-shini/AuthService/refs/heads/main/read-model/img/Status.png",
            label: { pt: "Monitor da API",          en: "API Monitor" },
            sub:   { pt: "Status, latência e logs", en: "Status, latency & logs" },
            description: {
